...
s_sql="select id,title,cid,pid,ppid,file_path,from_name,OrderCount,image,index_push,slide_yes,special_yes,view_yes,headline,hit,ip,time from Article where [title] like '%"&keywords&"%'   and ArticleType=2 order by [OrderCount],time desc"
elseif pid="" and ppid="" then
search_sql="and cid='"&cid&"'"
s_sql="select id,title,cid,pid,ppid,file_path,from_name,OrderCount,image,index_push,slide_yes,special_yes,view_yes,headline,hit,ip,time from Article where [title] like '%"&keywords&"%'"&search_sql&" and ArticleType=2 order by [OrderCount],time desc"
elseif ppid="" then
...
s_sql="select id,title,cid,pid,ppid,file_path,from_name,OrderCount,image,index_push,slide_yes,special_yes,view_yes,headline,hit,ip,time from Article where ArticleType=2 order by [OrderCount],time desc"
 ...
 <form name="form2" method="post" action="Product_Del.asp?action=AllDel&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
          <tr>
            ...
            <td width="9%" class="TitleHighlight"><div align="center" style="font-weight: bold;color:#ffffff">排序</div></td>
