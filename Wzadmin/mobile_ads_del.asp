...
sql="select id from mobile_web_ads where id="&article_id&""
rs.open(sql),cn,1,3
rs.delete
rs.close
set rs=nothing
...
call index_to_html()
response.Write "<script language='javascript'>alert('删除成功！');location.href='mobile_ads_list.asp?page="&page&"&act="&act&"&keywords="&keywords&"';</script>"
			%></td>
          </tr>
        </table>
	    </td>
