...
t=outlookbar.addtitle('手机基本设置','手机网站管理',1)
outlookbar.additem('手机网站设置',t,'mobile_web_settings.asp')

t=outlookbar.addtitle('手机导航管理','手机网站管理',2)
outlookbar.additem('添加导航',t,'mobile_menu_type_add.asp')
outlookbar.additem('导航列表',t,'mobile_menu_type_list.asp')

t=outlookbar.addtitle('手机广告管理','手机网站管理',3)
outlookbar.additem('广告位置管理',t,'mobile_ads_position_list.asp')
outlookbar.additem('添加广告',t,'mobile_ads_add.asp')
outlookbar.additem('广告列表',t,'mobile_ads_list.asp')

t=outlookbar.addtitle('手机生成静态','手机网站管理',4)
outlookbar.additem('生成首页',t,'mobile_html_index.asp')
outlookbar.additem('生成栏目',t,'mobile_html_items.asp')
outlookbar.additem('生成内容',t,'mobile_html_article.asp')
outlookbar.additem('生成所有页面',t,'mobile_html_all.asp')
...
t=outlookbar.addtitle('手机生成静态','静态管理',2)
outlookbar.additem('生成首页',t,'mobile_html_index.asp')
outlookbar.additem('生成栏目',t,'mobile_html_items.asp')
outlookbar.additem('生成内容',t,'mobile_html_article.asp')
outlookbar.additem('生成所有页面',t,'mobile_html_all.asp')
