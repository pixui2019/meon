...
function showInnerText(Id){
	...
	switch(switchId){
	    case 1:
		   showText =  "进入系统后，首先在这里对网站进行配置，包含网站名称、网址、导航、广告、友情链接等信息。";
		   break;
	    case 2:
...
<%End If %>
    <li id="man_nav_5"  onclick="list_sub_nav(id,'手机网站管理')"  class="bg_image">手机网站管理</li>
    
    <li id="man_nav_6"  onclick="list_sub_nav(id,'静态管理')"  class="bg_image">静态管理</li>
    </ul>
</div>
<div id="sub_info">&nbsp;&nbsp;<img src="images/hi.gif" />&nbsp;<span id="show_text">欢迎登录 <strong><%=gdb("select web_name from web_settings ")%></strong> 网站后台管理!</span></div>
</body>
</html>
