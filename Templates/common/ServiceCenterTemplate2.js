...
'<tr>' + 
'<td style="border:0;padding:0;font-size:13px;background:url(/images/qqimg/center_1.gif) repeat;" height="20"><img src="/images/qqimg/head.gif"  border="0" style="margin:0px; padding:0px;" usemap="#MapMapMap"></td>' + 
'</tr>' + 
'<tr>' + 
