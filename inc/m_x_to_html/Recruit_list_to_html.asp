...
'招聘列表模板类型获取
set rs_1=server.createobject("adodb.recordset")
sql="select FileName,FolderName from mobile_web_Models_type where [id]=32"
rs_1.open(sql),cn,1,1
...
list_block=list_block&"<tr><td width='24%' align='center' bgcolor='#F9F9F9'>工作地点：</td>"
list_block=list_block&"<td width='76%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("address")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='24%' align='center' bgcolor='#F9F9F9'>工资待遇：</td>"
list_block=list_block&"<td width='76%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("person")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='24%' align='center' bgcolor='#F9F9F9'>招聘人数：</td>"
list_block=list_block&"<td width='76%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("tel")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='24%' align='center' bgcolor='#F9F9F9'>性别要求：</td>"
list_block=list_block&"<td width='76%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("email")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='24%' align='center' bgcolor='#F9F9F9'>年龄要求：</td>"
list_block=list_block&"<td width='76%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("qq")&"</strong></td></tr>"
list_block=list_block&"<tr><td width='24%' align='center' bgcolor='#F9F9F9'>条件要求：</td>"
list_block=list_block&"<td width='76%' align='left' bgcolor='#FFFFFF'><strong>&nbsp;"&rs("description")&"</strong></td></tr>"
