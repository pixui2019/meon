...
select case TypeID
case 1
web_qqs=web_qqs&"document.writeln(""<p>客服"&i+1&": <a target=\'_blank\' href=\'tencent:\/\/message\/?uin="&web_qq(i)&"&Site=www.My.com&Menu=yes\'><img  SRC=\'http:\/\/wpa.qq.com\/pa?p=1:"&web_qq(i)&":1\' alt=\'在线咨询\'><\/a><\/p>""); "
...
web_qqs=web_qqs&"'<span style=text-decoration:none;font-size:12;color:#3477B7;text-align:left><a style=text-decoration:none; href=tencent://message/?uin="&web_qq(i)&"&Site=www.My.com&Menu=yes target=_blank><img src=/images/qqimg/webQQ.gif style=margin:0px; padding:0px; align=texttop></a></span>' + "
web_qqs=web_qqs&"'</td>' + "
web_qqs=web_qqs&"'</tr>' + "
end select
next
